...
comment on function public.command_apply_engagement_proposal_workflow_recommendation(
  ...
  'Applies one Proposal recommendation to its selected Active job, mirrors primary compatibility fields, reconciles only that job, and records idempotent Activity.';
